...
public class GamePlayerAI extends GamePlayer {
    ...
    public String makeInput() {
        ...
        if (board.getA1().getText().toString().equals("x") && board.getA2().getText().toString().equals("x") && board.getA3().getText().toString().equals(" ")
            ...
            input = "a3";
        } else if (board.getB1().getText().toString().equals("x") && board.getB2().getText().toString().equals("x") && board.getB3().getText().toString().equals(" ")) {
            input = "b3";
            ...
            input = "a1";
        } else if (board.getB2().getText().toString().equals("x") && board.getB3().getText().toString().equals("x") && board.getB1().getText().toString().equals(" ")) {
            input = "b1";
