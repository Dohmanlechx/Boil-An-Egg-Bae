...
public class GamePlayerAI extends GamePlayer {
    ...
    public String makeInput() {
        ...
        // Sätter alltid O i mitten (B2) så länge den är ledig
        if (board.getB2().getText().toString().equals(" ")
                || board.getA3().getText().toString().equals("o") && board.getC1().getText().toString().equals("o") && board.getB2().getText().toString().equals(" ")
                || board.getA1().getText().toString().equals("o") && board.getC3().getText().toString().equals("o") && board.getB2().getText().toString().equals(" ")) {
            input = "b2";
        } else if (board.getA1().getText().toString().equals("o") && board.getA2().getText().toString().equals("o") && board.getA3().getText().toString().equals(" ")
            ...
            input = "a3";
                ...
                || board.getA3().getText().toString().equals("x") && board.getC3().getText().toString().equals("x") && board.getB3().getText().toString().equals(" ")
            ...
            input = "a1";
                ...
                || board.getA1().getText().toString().equals("x") && board.getC1().getText().toString().equals("x") && board.getB1().getText().toString().equals(" ")
            ...
            input = "c1";
        } else if (board.getA3().getText().toString().equals("x") && board.getC1().getText().toString().equals("x") && board.getB2().getText().toString().equals(" ")
                || board.getA1().getText().toString().equals("x") && board.getC3().getText().toString().equals("x") && board.getB2().getText().toString().equals(" ")) {
            input = "b2";
        } else if (board.getA1().getText().toString().equals("x") && board.getA2().getText().toString().equals("x") && board.getA3().getText().toString().equals(" ")
            ...
            input = "a3";
        } else if (board.getC1().getText().toString().equals("x") && board.getC2().getText().toString().equals("x") && board.getC3().getText().toString().equals(" ")
            ...
            input = "c3";
        } else if (board.getB2().getText().toString().equals("x") && board.getC2().getText().toString().equals("x") && board.getA2().getText().toString().equals(" ")
                || board.getA1().getText().toString().equals("x") && board.getA3().getText().toString().equals("x") && board.getA2().getText().toString().equals(" ")) {
            input = "a2";
        } else if (board.getA2().getText().toString().equals("x") && board.getB2().getText().toString().equals("x") && board.getC2().getText().toString().equals(" ")
                || board.getC1().getText().toString().equals("x") && board.getC3().getText().toString().equals("x") && board.getC2().getText().toString().equals(" ")) {
            input = "c2";
        } else if (board.getA2().getText().toString().equals("x") && board.getA3().getText().toString().equals("x") && board.getA1().getText().toString().equals(" ")
            ...
            input = "a1";
        } else if (board.getC2().getText().toString().equals("x") && board.getC3().getText().toString().equals("x") && board.getC1().getText().toString().equals(" ")
